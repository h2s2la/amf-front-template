...
// export const getMyCampground = async ({id}) =>
// 	axios.get(`${CAMPGROUND_URL}/detail/user/${id}`);
...
// 	axios.patch(`${CAMPGROUND_URL}/${id}`, params);

// export const updateCampsite = async ({id}, params) =>
// 	axios.patch(`${CAMPSITE_URL}/${id}`, params);

// export const getCampsiteList = async () => axios.get(`${CAMPSITE_URL}`);

// export const getCampsiteListFindByGround = async ({id}, memberGrade) =>
// 	axios.get(`${CAMPSITE_URL}/${id}/${memberGrade}`);
